...
The supported serial set is `SLUS-01222`. The package uses
...
The corrected source uses `Colin_McRae_Rally_2_0_Recompiled` for CMake, the setup relaunch, and packaging.
