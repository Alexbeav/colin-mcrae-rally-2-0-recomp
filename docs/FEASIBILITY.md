# Colin McRae Rally 2.0 release feasibility
...
The supported serial set is $(@{ordinal=4; slug=colin-mcrae-rally-2-0; title=Colin McRae Rally 2.0; serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
