# Colin McRae Rally 2.0 knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SLUS-01222`
...
The source now uses `Colin_McRae_Rally_2_0_Recompiled` as the only setup executable name. The batch source
