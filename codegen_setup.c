...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "colin-mcrae-rally-2-0-",
    .project_root_env = "COLIN_MCRAE_RALLY_2_0_RECOMP_PROJECT_ROOT",
    .build_dir_env = "COLIN_MCRAE_RALLY_2_0_RECOMP_BUILD_DIR",
    .force_setup_env = "COLIN_MCRAE_RALLY_2_0_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.22_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "colin_mcrae_rally_2_0__Recompiled",
    .prepare_note =
