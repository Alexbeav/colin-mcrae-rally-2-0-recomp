...
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/colin-mcrae-rally-2-0-recomp/latest/total)](https://github.com/Alexbeav/colin-mcrae-rally-2-0-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/colin-mcrae-rally-2-0-recomp)](https://github.com/Alexbeav/colin-mcrae-rally-2-0-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Colin McRae Rally 2.0** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Colin McRae Rally 2.0.
...
Zip prefix for CI artifacts: `Colin-McRae-Rally-2-0-Recomp`.
...
The `v0.3.3` source uses `Colin_McRae_Rally_2_0_Recompiled` in CMake, the setup relaunch, and the packager.
